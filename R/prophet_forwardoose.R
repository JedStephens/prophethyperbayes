...
#' @param testing_data the data upon which predictions should be tested. This must be a dataframe with at least the column ds (standing for date in POSXIT) and y which are the observed values
